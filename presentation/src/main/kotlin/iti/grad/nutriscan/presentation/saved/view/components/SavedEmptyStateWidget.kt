...
fun SavedEmptyStateWidget(
    ...
    Column(
        ...
        val imageRes = if (AppTheme.isDark) {
            R.drawable.saved_not_found_dark
        } else {
            R.drawable.saved_not_found_light
        }
        ...
        Text(
            text = stringResource(id = R.string.saved_empty_subtitle),
        ...
        AppButton(
            textResId = R.string.saved_empty_button,
            isLoading = false,
