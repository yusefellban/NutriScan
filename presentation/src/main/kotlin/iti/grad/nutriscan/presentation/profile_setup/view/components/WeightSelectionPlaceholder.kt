    ...
    Column(
        ...
        Text(
            text = buildAnnotatedString {
                append(stringResource(R.string.profile_setup_weight_title_prefix))
                withStyle(SpanStyle(color = AppTheme.colors.Primary, fontWeight = FontWeight.Bold)) {
                    append(stringResource(R.string.profile_setup_weight_title_highlight))
                }
            },
        ...
        // Subtitle
        Text(
            text = stringResource(R.string.profile_setup_weight_subtitle),
            fontFamily = LexendDeca,
