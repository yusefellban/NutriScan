    ...
    Column(
        ...
        Text(
            text = buildAnnotatedString {
                append(stringResource(R.string.profile_setup_dob_title_prefix))
                withStyle(SpanStyle(color = AppTheme.colors.Primary, fontWeight = FontWeight.Bold)) {
                    append(stringResource(R.string.profile_setup_dob_title_highlight))
                }
            },
        ...
        // Subtitle
        Text(
            text = stringResource(R.string.profile_setup_dob_subtitle),
            fontFamily = LexendDeca,
        ...
        // Placeholder body — TODO: implement actual date picker
        Text(
